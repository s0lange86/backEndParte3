...
describe('Tests integrales de SESSIONS', () => {
    let userTest // creamos esta variable para que sea dinamico el test y referenciar el mismo usuario con el que hacemos las pruebas
    ...
    it('[POST] /api/sessions/register - Debe registrar un usuario', async() => {
        ...
        expect(body.payload.password).to.not.be.equal(newUser.password); //la password tiene que estar hasheada
    })
